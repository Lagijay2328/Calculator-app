...
class QuickMathApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
    ...
    title: 'QuickMath',
    theme: ThemeData(brightness: Brightness.dark, scaffoldBackgroundColor: const Color(0xFF080B0D)),
...
class _QuickMathScreenState extends State<QuickMathScreen> {
  ...
  // ── palette ────────────────────────────────────────────────────────────
  static const _kBg    = Color(0xFF080B0D);
  static const _kSci   = Color(0xFF263238);
  static const _kSciTx = Color(0xFF78909C);
  static const _kNum   = Color(0xFF1A2326);
  static const _kOp    = Color(0xFF455A64);
  static const _kOpTx  = Color(0xFF78909C);
  static const _kFn    = Color(0xFF1A2326);
  static const _kEq    = Color(0xFF37474F);
      ...
      body: SafeArea(child: Column(children: [
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Text(disp,
              style: TextStyle(
                color: const Color(0xFF1A2A08), fontSize: 42.0,
